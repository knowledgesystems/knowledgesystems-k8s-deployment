...
<body class="${properties.kcBodyClass!}">
  ...
  <div class="${properties.kcLoginClass!}">
    ...
    <div style="font-size: 16px; font-family: 'Arial'; color: darkslategray; text-align: center;">
      If you have difficulties logging in, please visit <a href="https://docs.google.com/document/d/1T48zEOohS49T6JDaO4Eby9AVJ5xsrhi2vb1ibetxe7o/edit?usp=sharing">this page</a>.
    </div>
