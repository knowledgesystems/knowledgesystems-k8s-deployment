...
```
helm install --name gn-mongo-v0dot16 --version 7.3.1 --set image.repository=genomenexus/gn-mongo,image.tag=v0.16,persistence.size=50Gi bitnami/mongodb --namespace genome-nexus
```
